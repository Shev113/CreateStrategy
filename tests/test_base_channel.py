...
from strategy.base_channel import check_base_channel
...
class TestBaseChannel(unittest.TestCase):
    def test_no_signal_out_of_range(self):
        self.assertIsNone(check_base_channel([make_candle(100, 101, 102, 99)], 5, [100], 2.0))
    ...
    def test_no_signal_far_from_level(self):
        ...
        idx = len(candles) - 1
        signal = check_base_channel(candles, idx, [100], 10.0, level_proximity=0.5)
    ...
    def test_buy_signal(self):
        ...
        idx = len(candles) - 1
        signal = check_base_channel(candles, idx, [100], 2.0, atr_sl=1.0, atr_tp=2.0,
                                    bc_period=20, bc_vol_period=30, level_proximity=5.0)
